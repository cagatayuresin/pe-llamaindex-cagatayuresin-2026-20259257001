...
---
title: Milvus Vector Store with Full-Text Search
...
- `output_field_names (str)`: The field where outputs of this BM25 function are stored (default: “sparse\_embedding”).
